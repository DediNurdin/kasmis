<div class="container" style="margin-top: 60px;">
	<br>
	<h2>List Pemasukan <a href="<?=base_url('kas/pemasukan');?>" title="Tambah"><i class="fa fa-plus-square"
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">
					<a href="<?=base_url('kas/edit_pemasukan/'.$data->nomor);?>"><span
							class="badge badge-pill badge-success"><i class="fa fa-edit"></i> Edit</span></a> &nbsp;
					<a href="<?=base_url('kas/hapus_pemasukan/'.$data->nomor);?>"
